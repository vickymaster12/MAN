...
bot = telebot.TeleBot('7344773060:AAFnAFj0Z3-tMGbXuWUyfwEjKUIVLI50Wlk')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nJOIN BOTH CHANNELS TO GET FREE OR PAID ACCES \n\n @vickyoct2k08 AND @vickyoct2k08 \n\n NOW SEND YOUR USER ID TO @vickyoct2k08 FOR APPROVAL ")
...
def welcome_plan(message):
    user_name = message.from_user.first_name
    response = f'''{user_name}, ʙᴜʏ ᴋʀᴏ :- @vickyoct2k08 ❄
'''
    bot.reply_to(message, response)
